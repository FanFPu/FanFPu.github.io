...
od <- '/jdfsbjcas1/ST_BJ/P21H28400N0232/wangdi/xieguixiang/BRCAFigures/cellchat/mergeCellchat/mergeCellchat_image_extract/'
setwd(od)

x <- load('/jdfsbjcas1/ST_BJ/P21H28400N0232/wangdi/xieguixiang/BRCAFigures/cellchat/high_immune/cellchat_new/cellchat_interaction.RData')
cellchat_high_TIL <- get(x)
y <- load('/jdfsbjcas1/ST_BJ/P21H28400N0232/wangdi/xieguixiang/BRCAFigures/cellchat/low_immune/cellchat_new/cellchat_interaction.RData')
